<template>
  <div class="app-container">
    ...
    <div :key="key" style="margin-top:30px;">
      ...
      <div>
        <span v-permission="[0,1]" class="permission-alert">
          Both
          <el-tag class="permission-tag" size="small">admin</el-tag> and
          <el-tag class="permission-tag" size="small">editor</el-tag> can see this
        </span>
        <el-tag v-permission="[0,1]" class="permission-sourceCode" type="info">
    ...
    <div :key="'checkPermission'+key" style="margin-top:60px;">
      ...
      <el-tabs type="border-card" style="width:550px;">
        <el-tab-pane v-if="checkPermission([0])" label="Admin">
          Admin can see this
        ...
        <el-tab-pane v-if="checkPermission([1])" label="Editor">
          Editor can see this
          <el-tag class="permission-sourceCode" type="info">
        ...
        <el-tab-pane v-if="checkPermission([0,1])" label="Admin-OR-Editor">
          Both admin or editor can see this
          <el-tag class="permission-sourceCode" type="info">
            v-if="checkPermission([0,1])"
          </el-tag>
        </el-tab-pane>
      </el-tabs>
    </div>
